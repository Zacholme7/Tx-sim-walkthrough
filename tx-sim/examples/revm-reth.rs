...
async fn main() -> Result<()> {
    ...
    // Build a nodedb database. This will interface direclty with the underlying rethdb and fetch
    // all information from there rather than over the network
    let mut db = NodeDB::new("reth is syncing".to_string()).unwrap();
    ...
    db.insert_account_info(account, acc_info, InsertionType::OnChain);
